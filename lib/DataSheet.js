  ...
  _createClass(DataSheet, [{
    ...
    value: function handleKey(e) {
      ...
      if (deleteKeysPressed && !isEditing) {
        ...
        selectedCells.map(function (_ref, index) {
          var cell = _ref.cell,
              i = _ref.i,
              j = _ref.j;
          return !cell.readOnly ? _this3.onChange(i, j, '', selectedCells.length === index + 1) : null;
        });
        e.preventDefault();
    ...
    key: 'onChange',
    value: function onChange(i, j, val, lastIndex) {
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if (this.state.start.i === nextState.start.i && this.state.start.j === nextState.start.j && this.state.end.i === nextState.end.i && this.state.end.j === nextState.end.j && this.state.forceEdit === nextState.forceEdit && nextProps.data === this.props.data) return false;
    ...
    value: function render() {
      ...
      var isReverting = function isReverting(i, j) {
        return reverting.i === i && reverting.j === j;
      };
